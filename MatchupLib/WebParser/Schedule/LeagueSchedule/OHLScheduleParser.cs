...
{
    class OHLScheduleParser : CHLScheduleParser
    {
        ...
        protected override string LeagueStatLink
        {
            get
            {
                return "http://cluster.leaguestat.com/feed/?feed=modulekit&view=schedule&key=c680916776709578&fmt=json&client_code=ohl&lang=en&season_id=56&team_id=undefined&league_code=&fmt=json";
            }
        }
